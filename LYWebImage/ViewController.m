...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[CustomTableCell class] forCellReuseIdentifier:tableviewIndentity];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    CustomTableCell *cell = [tableView dequeueReusableCellWithIdentifier:tableviewIndentity];
    
    [cell.headView ly_setImageWithUrl:[NSURL URLWithString:self.imageArray[indexPath.row]]];
    return cell;
